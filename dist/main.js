...
function displayInboxTodos() {
    (0,_project_js__WEBPACK_IMPORTED_MODULE_2__.getData)()
...
function getData() {
    ...
    function createProject(newProject) {
        ...
        currentProject = (0,_object_js__WEBPACK_IMPORTED_MODULE_0__.project)(newProject.name, newProject.ID, [])
        
        newProject.todos.forEach(createTodos)

        function createTodos(value) {
            currentTodo = (0,_object_js__WEBPACK_IMPORTED_MODULE_0__.todo)(value.name, value.description, value.duedate, value.priority, value.ID)
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/intlFormat/index.js");
...
function displayTodo(project) {
    ...
    function displayTodos(value) {
        ...
        todoDuedate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(value.getDuedate()), {
            timeZone: 'UTC',
        })
...
function loadTodoCloseBtns(project) {
    ...
    for (let i = 0; i < buttons.length; i++) {
        buttons[i].addEventListener('click', () => {
            ...
            ;(0,_project_js__WEBPACK_IMPORTED_MODULE_1__.storeData)()
            displayTodo(project)
        })
    }
